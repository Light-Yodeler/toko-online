...
<body class="font-poppins antialiased" style="background: #edf2f7;">
    <div id="view" class="min-h-screen flex flex-col" x-data="{ sidenav: true }">
        <!-- Sidebar Toggle Button -->
        <button @click="sidenav = true"
            class="p-2 border-2 bg-white rounded-md border-gray-200 shadow-lg text-gray-500 focus:bg-teal-500 focus:outline-none focus:text-white absolute top-0 left-0 sm:hidden z-20">
        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <div id="sidebar"
                ...
                x-show="sidenav" @click.away="sidenav = false" style="z-index: 10;">
            ...
            <div class="flex flex-col flex-1 overflow-hidden">
                ...
                <main class="flex-1 overflow-y-auto p-4 bg-gray-100">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                        ...
                        <div class="py-4">
                            <div class="border-4 border-dashed border-gray-200 rounded-lg h-96 p-4 mb-4">
                                <p class="text-center text-gray-500">Content section 1</p>
                            </div>
                            <div class="border-4 border-dashed border-gray-200 rounded-lg h-96 p-4 mb-4">
                                <p class="text-center text-gray-500">Content section 2</p>
                            </div>
                            <div class="border-4 border-dashed border-gray-200 rounded-lg h-96 p-4 mb-4">
                                <p class="text-center text-gray-500">Content section 3</p>
                            </div>
                            <div class="border-4 border-dashed border-gray-200 rounded-lg h-96 p-4 mb-4">
                                <p class="text-center text-gray-500">Content section 4</p>
                            </div>
                        </div>
                    </div>
                </main>
                ...
                <footer class="bg-white border-t border-gray-200 py-4 px-6">
                    <div class="flex items-center justify-between">
                        <p class="text-sm text-gray-600">© 2023 Dashwind. All rights reserved.</p>
