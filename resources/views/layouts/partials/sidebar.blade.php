            ...
            <li>
                <form method="POST" action="{{ route('logout') }}" id="logout-form">
                    ...
                    <a href="{{ route('logout') }}"
                        ...
                        class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-red-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out flex items-center">
